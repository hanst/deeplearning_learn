...
def first_compile_train(base_model, new_model, datagen):
    ...
    new_model.fit_generator(datagen
                            .flow_from_directory('/Users/hanst/Documents/文档/医疗AI/NIH dataset/new_images',
                            target_size=(1024,1024), shuffle=True, class_mode='binary',batch_size=32
                                                ), epochs=3)
...
def fine_tune_model(base_model:Model, model: Model, num_epochs, datagen):
    ...
    history = model.fit_generator(datagen
                            .flow_from_directory('/Users/hanst/Documents/文档/医疗AI/NIH dataset/new_images',
                                                 target_size =(1024,1024), shuffle=True, class_mode='binary',batch_size=32),
                            epochs=num_epochs,callbacks=[checkpoint, tensor_board], class_weight={'Cardiomegaly':0.9, 'No Finding':0.1})
    return history
